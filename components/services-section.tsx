      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {servicesData.map((service) => (
            <Card
              key={service.id}
              className={`p-6 bg-card border-border rounded-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:border-primary/50 flex flex-col ${service.highlighted ? "border-primary shadow-lg shadow-primary/20" : ""
                }`}
            >
              {/* Service Header */}
              <div className="mb-6">
